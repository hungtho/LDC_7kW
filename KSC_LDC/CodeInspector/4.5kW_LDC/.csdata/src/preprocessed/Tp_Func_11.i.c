#line 1 "D:\\07_Working\\KSC_LDC\\source\\UDS\\Tp_Func.c"
...
#line 37 "D:\\07_Working\\KSC_LDC\\source\\UDS\\Tp_Func.h"
...
#line 36 "D:\\07_Working\\KSC_LDC\\source\\UDS\\Tp_Func.c"
...
#line 37 "D:\\07_Working\\KSC_LDC\\source\\UDS\\Tp_Func.c"
...
#line 38 "D:\\07_Working\\KSC_LDC\\source\\UDS\\Tp_Func.c"
...
#line 66 "D:\\07_Working\\KSC_LDC\\source\\UDS\\Tp_Func.c"
...
uint8_t u8g_TpTxBuf[ ( 150U ) ];
uint8_t u8g_TpRxBuf[ ( 150U ) ];
	...
	switch( u8s_TpTxState )
	{
		...
		case ( 2U ):
			if( u16s_STMin_tm >= u16s_STminTickCnt )
			{
				...
				if( u8s_TpTxDataCnt == 0U ){ u8s_TpTxState = ( 0U ); }
			}
			break;
		default:
			break;
...
uint8_t TpRecvProc ( uint8_t *u8p_IsEndFrame, uint8_t *u8p_RecvLen, uint8_t *u8p_ReqType )
{
  ...
  u32_CANMsgID = g_can_RxData_REQUEST.ID;
	...
	if( u32_CANMsgID == ( 0x18DA1AF9U ) ){ *u8p_ReqType = ( 0x01U ); }
	else if( u32_CANMsgID == ( 0x18DBFFF9U ) ){ *u8p_ReqType = ( 0x02U ); }
	else{ *u8p_ReqType = 0x00U; }

	if( *u8p_ReqType != 0x00U )
	{
		u8_FrameType = ( ( uint8_t )( ( ( u8_CANFrameData[ 0 ] ) & 0xF0U ) >> 4 ) );
		u8_Dlc = ( ( uint8_t )( ( ( u8_CANFrameData[ 0 ] ) & 0x0FU ) ) );
		...
		switch( u8_FrameType )
		{
			...
			case ( 2U ):  
				...
				else
				{
					...
					if( ( u8s_TpRxBufIdx + u8_DataLen ) >= ( 150U ) )
					{
						u8s_TpRxBufIdx = 0U;
						u8_ErrNo = ( 0x31U );
					}
			...
			case ( 3U ):  
				...
				if( u8_STmin < ( 1U ) ){ u16s_STminTickCnt = ( uint16_t )( ( 1U ) / ( 1U ) ); }
				else if( u8_STmin > ( 127U ) ){ u16s_STminTickCnt = ( uint16_t )( ( 127U ) / ( 1U ) ); }
				else{ u16s_STminTickCnt = ( uint16_t )( u8_STmin / ( 1U ) ); }
...
void TpSingleFrame ( uint8_t u8_DataLen )
{
	...
	TpSendFrame ( u8_TpFrame, u8_DataLen + 1U );
#line 373 "D:\\07_Working\\KSC_LDC\\source\\UDS\\Tp_Func.c"
...
#line 416 "D:\\07_Working\\KSC_LDC\\source\\UDS\\Tp_Func.c"
...
static void TpFlowControlFrame ( void )
{
	...
	u8_TpFrame[ 0 ] = ( uint8_t )( ( 3U ) << 4U );
	u8_TpFrame[ 1 ] = ( 8U );
	u8_TpFrame[ 2 ] = ( 20U );

	TpSendFrame ( u8_TpFrame, 3U );
#line 461 "D:\\07_Working\\KSC_LDC\\source\\UDS\\Tp_Func.c"
...
static void TpSendFrame ( const uint8_t *p_Data, uint8_t u8_Size )
{
	...
	g_can_TxData_18FEC91A.ID = ( 0x18DAF91AU );
	...
	CAN1_Drv_SendFrame( ( 10U ), g_can_TxData_18FEC91A );
	CAN0_Drv_SendFrame( ( 10U ), g_can_TxData_18FEC91A );

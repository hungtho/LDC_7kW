#line 1 "D:\\07_Working\\KSC_LDC\\source\\HAL\\HalPwm.c"
...
#line 36 "D:\\07_Working\\KSC_LDC\\source\\HAL\\HalPwm.c"
...
#line 37 "D:\\07_Working\\KSC_LDC\\source\\HAL\\HalPwm.h"
...
#line 37 "D:\\07_Working\\KSC_LDC\\source\\HAL\\HalPwm.c"
...
static volatile struct ETIMER_tag *stsp_ETIMER_3 = &(*(volatile struct ETIMER_tag *) 0xfbc24000UL);
...
{
	SPCSetPeripheralClockMode( 130, (((uint8_t)(2)) << 0) | (((uint8_t)(2)) << 3) );

	stsp_ETIMER_3->ENBL.R = 0x00U;  

	stsp_ETIMER_3->CH[ 0 ].CTRL1.B.CNTMODE = 0x01U;  
	stsp_ETIMER_3->CH[ 0 ].CTRL1.B.PRISRC = 0x18U;  
	stsp_ETIMER_3->CH[ 0 ].CTRL1.B.LENGTH = 1U;  
	stsp_ETIMER_3->CH[ 0 ].CTRL1.B.ONCE = 0U;  

	stsp_ETIMER_3->CH[ 0 ].CTRL2.B.OEN = 0U;  
	stsp_ETIMER_3->CH[ 0 ].CTRL2.B.OPS = 0U;  
	stsp_ETIMER_3->CH[ 0 ].CTRL2.B.OUTMODE = 0x08U;	 

	stsp_ETIMER_3->CH[ 0 ].CCCTRL.B.CLC1 = 0x03U;  
	stsp_ETIMER_3->CH[ 0 ].CCCTRL.B.CLC2 = 0x07U;  

	stsp_ETIMER_3->CH[ 0 ].COMP1.R = ( ( uint16_t )( ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) - ( ( ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) * ( 50U ) ) / 100U ) ) ) ;  
	stsp_ETIMER_3->CH[ 0 ].COMP2.R = ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U );  
	stsp_ETIMER_3->CH[ 0 ].CMPLD1.R = ( ( uint16_t )( ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) - ( ( ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) * ( 50U ) ) / 100U ) ) ) + ( ( uint16_t )( ( 2U * ( 200U ) ) / 25U ) );
	stsp_ETIMER_3->CH[ 0 ].CMPLD2.R = 0;

	stsp_ETIMER_3->CH[ 0 ].LOAD.R = ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U );  
	stsp_ETIMER_3->CH[ 0 ].CNTR.R = ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U );  

	

 
	stsp_ETIMER_3->CH[ 1 ].CTRL1.B.CNTMODE = 0x01U;  
	stsp_ETIMER_3->CH[ 1 ].CTRL1.B.PRISRC = 0x18U;  
	stsp_ETIMER_3->CH[ 1 ].CTRL1.B.LENGTH = 1U;  
	stsp_ETIMER_3->CH[ 1 ].CTRL1.B.ONCE = 0U;  

	stsp_ETIMER_3->CH[ 1 ].CTRL2.B.OEN = 0U;  
	stsp_ETIMER_3->CH[ 1 ].CTRL2.B.OPS = 1U;  
	stsp_ETIMER_3->CH[ 1 ].CTRL2.B.OUTMODE = 0x08U;	 

	stsp_ETIMER_3->CH[ 1 ].CCCTRL.B.CLC1 = 0x03U;  
	stsp_ETIMER_3->CH[ 1 ].CCCTRL.B.CLC2 = 0x07U;  

	stsp_ETIMER_3->CH[ 1 ].COMP1.R = ( ( uint16_t )( ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) - ( ( ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) * ( 50U ) ) / 100U ) ) );  
	stsp_ETIMER_3->CH[ 1 ].COMP2.R = ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) + ( ( uint16_t )( ( 2U * ( 200U ) ) / 25U ) );  
	stsp_ETIMER_3->CH[ 1 ].CMPLD1.R = ( ( uint16_t )( ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) - ( ( ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) * ( 50U ) ) / 100U ) ) );
	stsp_ETIMER_3->CH[ 1 ].CMPLD2.R = ( ( uint16_t )( ( 2U * ( 200U ) ) / 25U ) );

	stsp_ETIMER_3->CH[ 1 ].LOAD.R = ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U );  
	stsp_ETIMER_3->CH[ 1 ].CNTR.R = ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U );  

	

 
	stsp_ETIMER_3->CH[ 2 ].CTRL1.B.CNTMODE = 0x01U;  
	stsp_ETIMER_3->CH[ 2 ].CTRL1.B.PRISRC = 0x18U;  
	stsp_ETIMER_3->CH[ 2 ].CTRL1.B.LENGTH = 1U;  
	stsp_ETIMER_3->CH[ 2 ].CTRL1.B.ONCE = 0U;  

	stsp_ETIMER_3->CH[ 2 ].CTRL2.B.OEN = 0U;  
	stsp_ETIMER_3->CH[ 2 ].CTRL2.B.OPS = 1U;  
	stsp_ETIMER_3->CH[ 2 ].CTRL2.B.OUTMODE = 0x08U;	 

	stsp_ETIMER_3->CH[ 2 ].CCCTRL.B.CLC1 = 0x03U;  
	stsp_ETIMER_3->CH[ 2 ].CCCTRL.B.CLC2 = 0x07U;  

	stsp_ETIMER_3->CH[ 2 ].COMP1.R = ( ( uint16_t )( ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) - ( ( ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) * ( 50U ) ) / 100U ) ) );  
	stsp_ETIMER_3->CH[ 2 ].COMP2.R = ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) + ( ( uint16_t )( ( 2U * ( 200U ) ) / 25U ) );  
	stsp_ETIMER_3->CH[ 2 ].CMPLD1.R = ( ( uint16_t )( ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) - ( ( ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) * ( 50U ) ) / 100U ) ) );
	stsp_ETIMER_3->CH[ 2 ].CMPLD2.R = ( ( uint16_t )( ( 2U * ( 200U ) ) / 25U ) );

	stsp_ETIMER_3->CH[ 2 ].LOAD.R = 0;  
	stsp_ETIMER_3->CH[ 2 ].CNTR.R = 0;  

	

 
	stsp_ETIMER_3->CH[ 3 ].CTRL1.B.CNTMODE = 0x01U;  
	stsp_ETIMER_3->CH[ 3 ].CTRL1.B.PRISRC = 0x18U;  
	stsp_ETIMER_3->CH[ 3 ].CTRL1.B.LENGTH = 1U;  
	stsp_ETIMER_3->CH[ 3 ].CTRL1.B.ONCE = 0U;  

	stsp_ETIMER_3->CH[ 3 ].CTRL2.B.OEN = 0U;  
	stsp_ETIMER_3->CH[ 3 ].CTRL2.B.OPS = 0U;  
	stsp_ETIMER_3->CH[ 3 ].CTRL2.B.OUTMODE = 0x08U;	 

	stsp_ETIMER_3->CH[ 3 ].CCCTRL.B.CLC1 = 0x03U;  
	stsp_ETIMER_3->CH[ 3 ].CCCTRL.B.CLC2 = 0x07U;  

	stsp_ETIMER_3->CH[ 3 ].COMP1.R = ( ( uint16_t )( ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) - ( ( ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) * ( 50U ) ) / 100U ) ) ) + ( ( uint16_t )( ( 2U * ( 200U ) ) / 25U ) );  
	stsp_ETIMER_3->CH[ 3 ].COMP2.R = ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U );  
	stsp_ETIMER_3->CH[ 3 ].CMPLD1.R = ( ( uint16_t )( ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) - ( ( ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) * ( 50U ) ) / 100U ) ) ) + ( ( uint16_t )( ( 2U * ( 200U ) ) / 25U ) );
	stsp_ETIMER_3->CH[ 3 ].CMPLD2.R = 0;

	stsp_ETIMER_3->CH[ 3 ].LOAD.R = 0;  
	stsp_ETIMER_3->CH[ 3 ].CNTR.R = 0;  

	stsp_ETIMER_3->CH[ 3 ].STS.R = 0xFFFFU;
	stsp_ETIMER_3->CH[ 3 ].INTDMA.B.TCF2IE = 1U;
	(*((volatile uint16_t *)(0xFC040000U + 0x60U + ((uint16_t)(742) * sizeof (uint16_t))))) = ((uint16_t)(0x8000) | (uint16_t)(15));
}
...
void HalPwmBSetShift( uint16_t shift )
{
	if( shift < ( ( ( 80000000UL ) / ( 92000UL ) ) / 2U ) )
	{
		pwmB.phaseShift = shift;
	}
}
...
void PWM_ENSABLE ( void )
{
	stsp_ETIMER_3->CH[ 0 ].CTRL2.B.OEN = 1U;  
	stsp_ETIMER_3->CH[ 1 ].CTRL2.B.OEN = 1U;  
	stsp_ETIMER_3->CH[ 2 ].CTRL2.B.OEN = 1U;  
	stsp_ETIMER_3->CH[ 3 ].CTRL2.B.OEN = 1U;  

	stsp_ETIMER_3->ENBL.R = 0x0FU;  
}
...
void vector742 ( void )
{
	...
	shiftB = ( uint16_t )( pwmB.phaseShift - pwmB.phaseShiftActive );
	pwmB.phaseShiftActive = pwmB.phaseShift;

	stsp_ETIMER_3->CH[ 2 ].CMPLD1.R = ( uint16_t )( ( uint16_t )( ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) - ( ( ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) * ( 50U ) ) / 100U ) ) ) + ( uint16_t )shiftB;
	stsp_ETIMER_3->CH[ 2 ].CMPLD2.R = ( uint16_t )( ( uint16_t )( ( 2U * ( 200U ) ) / 25U ) ) + ( uint16_t )shiftB;
	stsp_ETIMER_3->CH[ 3 ].CMPLD1.R = ( uint16_t )( ( ( uint16_t )( ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) - ( ( ( ( ( uint32_t )(((((40000000U / 2U) * (2U * 20U)) / 5U) / 2U) / 1U) / ( 92000UL ) ) - 1U ) * ( 50U ) ) / 100U ) ) ) + ( ( uint16_t )( ( 2U * ( 200U ) ) / 25U ) ) + shiftB );
	stsp_ETIMER_3->CH[ 3 ].CMPLD2.R = ( uint16_t )( shiftB );

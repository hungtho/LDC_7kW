#line 1 "D:\\07_Working\\KSC_LDC\\source\\HAL\\HalPIT.c"
...
#line 37 "D:\\07_Working\\KSC_LDC\\source\\HAL\\HalPIT.h"
...
#line 38 "D:\\07_Working\\KSC_LDC\\source\\HAL\\HalPIT.h"
...
#line 40 "D:\\07_Working\\KSC_LDC\\source\\HAL\\LdcFaultDetection.h"
...
#line 36 "D:\\07_Working\\KSC_LDC\\source\\HAL\\HalPIT.c"
...
volatile uint8_t task_flag_1m = 1U;
uint8_t task_10m_cnt = 10U;
uint8_t task_100m_cnt = 105U;
...
static volatile struct PIT_tag *stsp_PIT_0 = &(*(volatile struct PIT_tag *) 0xfff84000UL);
...
void HalPIT_Init ( void )
{
  SPCSetPeripheralClockMode( 30, (((uint8_t)(2)) << 0) | (((uint8_t)(2)) << 3) );

  stsp_PIT_0->MCR.R = 1U;  
  stsp_PIT_0->CH[ 3 ].LDVAL.R = 15999U;  
  stsp_PIT_0->CH[ 3 ].CVAL.R  = 15999U;
  stsp_PIT_0->CH[ 3 ].TFLG.R  = 1U;  
  stsp_PIT_0->CH[ 3 ].TCTRL.R = 3U;  

  (*((volatile uint16_t *)(0xFC040000U + 0x60U + ((uint16_t)(229) * sizeof (uint16_t))))) = ((uint16_t)(0x8000) | (uint16_t)(7));

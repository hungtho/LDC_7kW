#line 1 "D:\\07_Working\\KSC_LDC\\source\\HAL\\Os.c"
...
#line 79 "D:\\07_Working\\KSC_LDC\\source\\HAL\\Os.h"
...
#line 42 "D:\\07_Working\\KSC_LDC\\source\\HAL\\Asw_Utility.h"
...
#line 36 "D:\\07_Working\\KSC_LDC\\source\\HAL\\Os.c"
...
static void TimeFunction_TT0 ( void );
static void TimeFunction_TT1 ( void );
static void TimeFunction_TT2 ( void );
...
static void TimeFunction_TT0 ( void )
{
	...
	Diagnostic_Fault ();
	LDC_Operation ();
	if( eng_LDC_Sts != en_LDC_Run ){ LDC_OFF (); }

	HalPwmBSetShift( pwmShiftB );
...
static void TimeFunction_TT2 ( void )
{
	...
	if( u8_DtcControl == ( 0x00U ) ){ DTC_Eeprom_Write(); }
	...
	if( eng_LDC_Sts != en_LDC_Run )
	{
		if( WriteEEPROM_Flag == 1U )
		{
			...
			EEP_WriteDataByIdentifier( &EEPROM_BUFFER_DTC[ 0 ], present_addr );

			 
			EEP_WriteDataByIdentifier( &EEPROM_BUFFER_DID[ 0 ], present_addr );

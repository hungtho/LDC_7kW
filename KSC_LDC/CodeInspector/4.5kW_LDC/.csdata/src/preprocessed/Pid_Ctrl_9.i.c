#line 1 "D:\\07_Working\\KSC_LDC\\source\\HAL\\Pid_Ctrl.c"
...
#line 37 "D:\\07_Working\\KSC_LDC\\source\\HAL\\Pid_Ctrl.h"
...
#line 38 "D:\\07_Working\\KSC_LDC\\source\\HAL\\Pid_Ctrl.h"
...
#line 36 "D:\\07_Working\\KSC_LDC\\source\\HAL\\Pid_Ctrl.c"
...
#line 64 "D:\\07_Working\\KSC_LDC\\source\\HAL\\Pid_Ctrl.c"

#line 80 "D:\\07_Working\\KSC_LDC\\source\\HAL\\Pid_Ctrl.c"

#line 96 "D:\\07_Working\\KSC_LDC\\source\\HAL\\Pid_Ctrl.c"
...
static uint32_t Ramp ( uint32_t u32_setpoint, uint32_t u32_ref );
...
static PI pi_V = { 0, 0, 0, ( ( int32_t )( ( 1.0 ) * 8192.0 ) ), ( ( int32_t )( ( 1.0 ) * 8192.0 ) ), ( ( int32_t )( ( 1.0 ) * 8192.0 ) ), ( ( int32_t )( ( 1.0 ) * 131072.0 ) ), ( ( int32_t )( ( 0.0 ) * 131072.0 ) ), ( ( int32_t )( ( 0.0 ) * 131072.0 ) ), ( ( int32_t )( ( 0.0 ) * 131072.0 ) ), ( ( int32_t )( ( 0.0 ) * 131072.0 ) ), ( ( int32_t )( ( 0.0 ) * 131072.0 ) ), ( ( int32_t )( ( 0.0 ) * 131072.0 ) ) };
static PI pi_I = { 0, 0, 0, ( ( int32_t )( ( 1.0 ) * 8192.0 ) ), ( ( int32_t )( ( 1.0 ) * 8192.0 ) ), ( ( int32_t )( ( 1.0 ) * 8192.0 ) ), ( ( int32_t )( ( 1.0 ) * 131072.0 ) ), ( ( int32_t )( ( 0.0 ) * 131072.0 ) ), ( ( int32_t )( ( 0.0 ) * 131072.0 ) ), ( ( int32_t )( ( 0.0 ) * 131072.0 ) ), ( ( int32_t )( ( 0.0 ) * 131072.0 ) ), ( ( int32_t )( ( 0.0 ) * 131072.0 ) ), ( ( int32_t )( ( 0.0 ) * 131072.0 ) ) };
 
static uint32_t u32_VoRef_Max = 0U;
...
void PI_Init ( void )
{
	...
	pi_V.Kp= ( ( int32_t )( ( 0.90 ) * 8192.0 ) );
	pi_V.Ki= ( ( int32_t )( ( 0.5 ) * 8192.0 ) );
	pi_V.Kc= ( ( int32_t )( ( 0.50 ) * 8192.0 ) );
	...
	pi_I.Kp= ( ( int32_t )( ( 0.350 ) * 8192.0 ) );
	pi_I.Ki= ( ( int32_t )( ( 0.04 ) * 8192.0 ) );
	pi_I.Kc= ( ( int32_t )( ( 0.10 ) * 8192.0 ) );
	pi_I.Umax = ( ( int32_t )( ( 0.95 ) * 131072.0 ) );
	pi_I.Umin = ( ( int32_t )( ( 0.001 ) * 131072.0 ) );
...
#line 235 "D:\\07_Working\\KSC_LDC\\source\\HAL\\Pid_Ctrl.c"

#line 264 "D:\\07_Working\\KSC_LDC\\source\\HAL\\Pid_Ctrl.c"
...
uint16_t PI_Controller( uint32_t u32_IRef, uint32_t u32_VRef, uint32_t u32_Ifbk, uint32_t u32_Vfbk )
{
	int32_t s32_shift = 0;

	 
	u32_VoRef_Max = Ramp( u32_VRef, u32_VoRef_Max );

#line 289 "D:\\07_Working\\KSC_LDC\\source\\HAL\\Pid_Ctrl.c"

#line 297 "D:\\07_Working\\KSC_LDC\\source\\HAL\\Pid_Ctrl.c"


	pi_V.Ref = ( int32_t )( u32_VoRef_Max );
	pi_V.Fbk = ( int32_t )( u32_Vfbk );
	pi_V.Umax = ( int32_t )( u32_IRef );
	pi_V.Umin = ( int32_t )( 0 );

	pi_V . err = pi_V . Ref - pi_V . Fbk; pi_V . up = ( ( int32_t ) ( ( ( pi_V . Kp ) * ( pi_V . err ) ) / 8192 ) ); pi_V . ui = pi_V . ui + ( ( int32_t ) ( ( ( pi_V . Ki ) * ( pi_V . up ) ) / 8192 ) ) + ( ( int32_t ) ( ( ( pi_V . Kc ) * ( pi_V . satErr ) ) / 8192 ) ); pi_V . preSatErr = pi_V . up + pi_V . ui; pi_V . Out = SATURATION( pi_V . preSatErr, pi_V . Umax, pi_V . Umin ); pi_V . satErr = pi_V . Out - pi_V . preSatErr;;

	pi_I.Ref = ( int32_t )( pi_V.Out );
	pi_I.Fbk = ( int32_t )( u32_Ifbk );
	pi_I . err = pi_I . Ref - pi_I . Fbk; pi_I . up = ( ( int32_t ) ( ( ( pi_I . Kp ) * ( pi_I . err ) ) / 8192 ) ); pi_I . ui = pi_I . ui + ( ( int32_t ) ( ( ( pi_I . Ki ) * ( pi_I . up ) ) / 8192 ) ) + ( ( int32_t ) ( ( ( pi_I . Kc ) * ( pi_I . satErr ) ) / 8192 ) ); pi_I . preSatErr = pi_I . up + pi_I . ui; pi_I . Out = SATURATION( pi_I . preSatErr, pi_I . Umax, pi_I . Umin ); pi_I . satErr = pi_I . Out - pi_I . preSatErr;;


	s32_shift = ( int32_t )( ( pi_I.Out * 430 ) / 131072 );

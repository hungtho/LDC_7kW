#line 1 "D:\\07_Working\\KSC_LDC\\source\\HAL\\CAN_Drv.c"
...
#line 37 "D:\\07_Working\\KSC_LDC\\source\\HAL\\CAN_Drv.h"
...
#line 36 "D:\\07_Working\\KSC_LDC\\source\\HAL\\CAN_Drv.c"
...
#line 50 "D:\\07_Working\\KSC_LDC\\source\\HAL\\CAN_Drv.c"

#line 59 "D:\\07_Working\\KSC_LDC\\source\\HAL\\CAN_Drv.c"
...
static void CAN1_lld_err_handler ( void );
static void CAN0_lld_err_handler ( void );
...
CAN_MESSAGE_OBJECT_t g_can_TxData_18FF041A;
CAN_MESSAGE_OBJECT_t g_can_TxData_18FECA1A;
CAN_MESSAGE_OBJECT_t g_can_TxData_18ECFF1A;  
CAN_MESSAGE_OBJECT_t g_can_TxData_18EBFF1A;  
uint8_t RecvNewDataforDiag;
uint32_t TimeoutCan1Cnt = 0U;
uint32_t TimeoutCan2Cnt = 0U;
uint8_t u8_can1BusOffFlag = 0;
uint8_t u8_can2BusOffFlag = 0;
...
static volatile struct FLEXCAN_tag *stsp_CAN_Main = &(*(volatile struct FLEXCAN_tag *) 0xfbec0000UL);
static volatile struct FLEXCAN_tag *stsp_CAN_Sub = &(*(volatile struct FLEXCAN_tag *) 0xffec0000UL);
static const uint32_t RX_Id_Table[ ( 3U ) ] =
{
	0x18FF31EFU,
	( 0x18DA1AF9U ),
	( 0x18DBFFF9U )
...
void Hal_CAN1_Init ( void )
{
	...
	SPCSetPeripheralClockMode( 207, (((uint8_t)(2)) << 0) | (((uint8_t)(2)) << 3) );

	stsp_CAN_Main->MCR.B.HALT = 1U;  
  stsp_CAN_Main->MCR.B.MDIS = 0U;  

   
  stsp_CAN_Main->MCR.B.FEN = 1U;  
  stsp_CAN_Main->MCR.B.IDAM = 0U;  
  stsp_CAN_Main->MCR.B.BCC = 1U;  

  stsp_CAN_Main->CTRL.B.PRESDIV = 1U;  
  stsp_CAN_Main->CTRL.B.RJW = 0U;  
  stsp_CAN_Main->CTRL.B.PROPSEG = 7U;  
  stsp_CAN_Main->CTRL.B.PSEG1 = 6U;  
  stsp_CAN_Main->CTRL.B.PSEG2 = 3U;  

	stsp_CAN_Main->CTRL.B.LPB = 0U;  
	stsp_CAN_Main->MCR.B.SRX_DIS = 1U;  

  stsp_CAN_Main->IMASK1.B.BUF5M = 1U;  

	stsp_CAN_Main->MB[0].MB_CS.R = 0x04000000U;  

	stsp_CAN_Main->MCR.B.MDIS = 0U;  

	 
	for( u8_MsgBufIdx = 0U; u8_MsgBufIdx < ( 3U ); u8_MsgBufIdx++ )
	{
		stsp_CAN_Main->MB[ u8_MsgBufIdx ].MB_CS.B.IDE = 1U;  
		stsp_CAN_Main->MB[ u8_MsgBufIdx ].MB_ID.B.ID = RX_Id_Table[ u8_MsgBufIdx ];
		stsp_CAN_Main->MB[ u8_MsgBufIdx ].MB_CS.B.CODE = 4U;
	}

  ( *(vuint32_t* )( 0xFBEC00E0UL ) ) = ( RX_Id_Table[ 0 ] << 1 ) | ( 0x40000000 );  
  ( *(vuint32_t* )( 0xFBEC00E4UL ) ) = ( RX_Id_Table[ 1 ] << 1 ) | ( 0x40000000 );  
  ( *(vuint32_t* )( 0xFBEC00E8UL ) ) = ( RX_Id_Table[ 2 ] << 1 ) | ( 0x40000000 );  
  ( *(vuint32_t* )( 0xFBEC00ECUL ) ) = ( 0x00000000U << 1U ) | ( 0x40000000U );  
  ( *(vuint32_t* )( 0xFBEC00F0UL ) ) = ( 0x00000000U << 1U ) | ( 0x40000000U );  
  ( *(vuint32_t* )( 0xFBEC00F4UL ) ) = ( 0x00000000U << 1U ) | ( 0x40000000U );  
  ( *(vuint32_t* )( 0xFBEC00F8UL ) ) = ( 0x00000000U << 1U ) | ( 0x40000000U );  
  ( *(vuint32_t* )( 0xFBEC00FCUL ) ) = ( 0x00000000U << 1U ) | ( 0x40000000U );  
  ...
  stsp_CAN_Main->MCR.R |= ( 1UL << 21 );
  stsp_CAN_Main->CTRL.R |= ( 1UL<< 15 );

  (*((volatile uint16_t *)(0xFC040000U + 0x60U + ((uint16_t)(701) * sizeof (uint16_t))))) = ((uint16_t)(0x8000) | (uint16_t)(5));
  (*((volatile uint16_t *)(0xFC040000U + 0x60U + ((uint16_t)(691) * sizeof (uint16_t))))) = ((uint16_t)(0x8000) | (uint16_t)(5));

	stsp_CAN_Main->MCR.B.HALT = 0U;   
}
...
void Hal_CAN0_Init ( void )
{
	uint8_t u8_MsgBufIdx;

	SPCSetPeripheralClockMode( 79, (((uint8_t)(2)) << 0) | (((uint8_t)(2)) << 3) );

	stsp_CAN_Sub->MCR.B.HALT = 1U;  
  stsp_CAN_Sub->MCR.B.MDIS = 0U;  

   
  stsp_CAN_Sub->MCR.B.FEN = 1U;  
  stsp_CAN_Sub->MCR.B.IDAM = 0U;  
  stsp_CAN_Sub->MCR.B.BCC = 1;  

  stsp_CAN_Sub->CTRL.B.PRESDIV = 1U;  
  stsp_CAN_Sub->CTRL.B.RJW = 0U;  
  stsp_CAN_Sub->CTRL.B.PROPSEG = 7U;  
  stsp_CAN_Sub->CTRL.B.PSEG1 = 6U;  
  stsp_CAN_Sub->CTRL.B.PSEG2 = 3U;  

	stsp_CAN_Sub->CTRL.B.LPB = 0U;  
	stsp_CAN_Sub->MCR.B.SRX_DIS = 1U;  

  stsp_CAN_Sub->IMASK1.B.BUF5M = 1U;  

	 
	for( u8_MsgBufIdx = 0U; u8_MsgBufIdx < ( 3U ); u8_MsgBufIdx++ )
	{
		stsp_CAN_Sub->MB[ u8_MsgBufIdx ].MB_CS.B.IDE = 1U;  
		stsp_CAN_Sub->MB[ u8_MsgBufIdx ].MB_ID.B.ID = RX_Id_Table[ u8_MsgBufIdx ];
		stsp_CAN_Sub->MB[ u8_MsgBufIdx ].MB_CS.B.CODE = 4U;
	}

  ( *(vuint32_t* )( 0xFFEC00E0UL ) ) = ( RX_Id_Table[ 0 ] << 1 )|( 0x40000000 );  
  ( *(vuint32_t* )( 0xFFEC00E4UL ) ) = ( RX_Id_Table[ 1 ] << 1 )|( 0x40000000 );  
  ( *(vuint32_t* )( 0xFFEC00E8UL ) ) = ( RX_Id_Table[ 2 ] << 1 )|( 0x40000000 );  
  ( *(vuint32_t* )( 0xFFEC00ECUL ) ) = ( 0x00000000U << 1U ) | ( 0x40000000U );  
  ( *(vuint32_t* )( 0xFFEC00F0UL ) ) = ( 0x00000000U << 1U ) | ( 0x40000000U );  
  ( *(vuint32_t* )( 0xFFEC00F4UL ) ) = ( 0x00000000U << 1U ) | ( 0x40000000U );  
  ( *(vuint32_t* )( 0xFFEC00F8UL ) ) = ( 0x00000000U << 1U ) | ( 0x40000000U );  
  ( *(vuint32_t* )( 0xFFEC00FCUL ) ) = ( 0x00000000U << 1U ) | ( 0x40000000U );  
  ...
  stsp_CAN_Sub->MCR.R |= ( 1UL << 21 );
  stsp_CAN_Sub->CTRL.R |= ( 1UL<< 15 );

  (*((volatile uint16_t *)(0xFC040000U + 0x60U + ((uint16_t)(688) * sizeof (uint16_t))))) = ((uint16_t)(0x8000) | (uint16_t)(5));
  (*((volatile uint16_t *)(0xFC040000U + 0x60U + ((uint16_t)(678) * sizeof (uint16_t))))) = ((uint16_t)(0x8000) | (uint16_t)(5));

	stsp_CAN_Sub->MCR.B.HALT = 0U;  
...
void CAN0_Drv_SendFrame ( uint8_t mailbox, CAN_MESSAGE_OBJECT_t g_can_TxData )
{
...
void vector701 ( void )
{
	CAN1_lld_err_handler();
	u8_can1BusOffFlag = 1U;
}
...
void vector688 (void )
{
	CAN0_lld_err_handler();
	u8_can2BusOffFlag = 1U;
}

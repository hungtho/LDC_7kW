#line 1 "D:\\07_Working\\KSC_LDC\\source\\HAL\\StateMachine.c"
...
#line 37 "D:\\07_Working\\KSC_LDC\\source\\HAL\\StateMachine.h"
...
#line 83 "D:\\07_Working\\KSC_LDC\\source\\HAL\\StateMachine.h"
...
#line 36 "D:\\07_Working\\KSC_LDC\\source\\HAL\\StateMachine.c"
...
static void Sts_Run ( void )
{
	...
	Derating_Temperature ( realTemp );
	VoReference = UTILS_REF_INV ( ( 280U ), AdcVout, Vout ) << 5U;
	pwmShiftB = PI_Controller( IoReference, VoReference, AdcIout_Q15, AdcVout_Q15 );


#line 386 "D:\\07_Working\\KSC_LDC\\source\\HAL\\StateMachine.c"
...
static void Sts_PowerLatch( void )
{
	...
	if( u16s_PowerLatch_cnt >= ( 5000U ) )
	{
		((*(volatile struct SIUL2_tag *) 0xfffc0000UL). GPDO[((0U) * 16U) + (11U)]. R = 0);  
	}
	else
	{
		u16s_PowerLatch_cnt++;
		...
		if( GetIgnSts() == 1U )
		{
			( ( u32g_LDC_ERR_Sts ) &= ( uint32_t )( ~( ( ( uint32_t )( 0x00000080 ) ) | ( ( uint32_t )( 0x00000040 ) ) | ( ( uint32_t )( 0x00002000 ) ) | ( ( uint32_t )( 0x00004000 ) ) | ( ( uint32_t )( 0x00000800 ) ) | ( ( uint32_t )( 0x00001000 ) ) ) & 0xFFFFFFFFU ) );
#line 508 "D:\\07_Working\\KSC_LDC\\source\\HAL\\StateMachine.c"
...
static uint8_t GetRecoveryError ( void )
{
	...
	u32_ErrSts = ( ( uint32_t )( 0x00040000 ) )
						 | ( ( uint32_t )( 0x00008000 ) )
						 | ( ( uint32_t )( 0x00080000 ) )
						 | ( ( uint32_t )( 0x00010000 ) )
						 | ( ( uint32_t )( 0x00000010 ) )
...
static uint8_t GetNonRecoveryError ( void )
{
	...
	u32_ErrSts = ( ( uint32_t )( 0x00000080 ) )
			       | ( ( uint32_t )( 0x00000040 ) )
						 | ( ( uint32_t )( 0x00002000 ) )
						 | ( ( uint32_t )( 0x00004000 ) )
						 | ( ( uint32_t )( 0x00000800 ) )
